        ...
        <div class="content-wrapper">
          ...
          <div class="content-text">
            ...
            <p class="section-description">
              VogFashion 利用最先进的人工智能技术，结合对时尚潮流的深入理解，为每位用户提供量身定制的时尚体验。
    ...
    <div class="footer">
      <div class="container">
        <div class="footer-content">
          ...
          <p class="footer-text">&copy; {{ new Date().getFullYear() }} VogFashion. 保留所有权利。</p>
        </div>
      </div>
    </div>
...
const faqs = ref([
  ...
  {
    question: '支持哪些设备使用？',
    answer: 'VogFashion支持所有主流设备，包括手机、平板、电脑，同时提供iOS和Android原生应用。',
    open: false
  }
])
